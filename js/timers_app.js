  ...
  return {
    ...
    addNewCustomerLine: function (obj, type) {
      ...
      if (type === 'kfc') {
        ...
        html = '<div class="row py-1 info-container times-container" id="kfc-%id%"><div class="col-4 col-md-3 text-center align-content-center "><input type="text" class="form-control timer" placeholder="Customer description" id="kfc-description%id%"></div><div class="col-3 col-md-6"><div class="d-flex justify-content-between"><div class="col-6 col-md-4 d-none d-md-block text-center"><p class="form-control timer active" id="kfc-start__time%id%">%timeStart%</p></div><div class="col-0 text-center"><p class="form-control timer" id="kfc-paid__time%id%" hidden>Order time</p></div><div class="col-6 col-md-4 d-none d-md-block text-center"><p class="form-control timer" id="kfc-stop__time%id%">Time stop</p></div><div class="col-0 text-center"><p class="form-control timer" id="kfc-otd__time%id%" hidden>Window time</p></div><div class="col-12 col-md-4 text-center "><p class="form-control timer totalTIme-small" id="kfc-total__time%id%">Service time</p></div></div></div><div class="col-5 col-md-3 text-center"><div class="d-flex justify-content-around"><div class="editBox" id="kfc-paid-%id%" hidden><i class="far fa-money-bill-alt"></i></div><div class="editBox" id="kfc-stop-%id%"><img src="./img/fried-chicken-meal.png" class="food-img"/></div><div class="editBox" id="kfc-trash-%id%"><img src="./img/bin.png" class="food-img"/></div></div></div></div></div>'; 
      }
      ...
      if(type === 'kfc_DT') {
        ...
        elementID = obj.id; // to be able to start new stopwatch
        html = '<div class="row py-1 info-container times-container" id="kfc_DT-%id%"><div class="col-4 col-md-3 text-center align-content-center"><input type="text" class="form-control timer" placeholder="Customer description" id="kfc_DT-description%id%"></div><div class="col-3 col-md-6"><div class="d-flex justify-content-between"><div class="col-0 col-md-4 d-none d-md-block text-center"><p class="form-control timer active" id="kfc_DT-start__time%id%">%timeStart%</p></div><div class="col-0 text-center"><p class="form-control timer" id="kfc_DT-paid__time%id%" hidden>Order time</p></div><div class="col-0 col-md-4 d-none d-md-block text-center"><p class="form-control timer" id="kfc_DT-stop__time%id%">Time stop</p></div><div class="col-0 text-center"><p class="form-control timer" id="kfc_DT-otd__time%id%" hidden>Window time</p></div><div class="col-12 col-md-4 text-center"><p class="form-control timer totalTIme-small" id="kfc_DT-total__time%id%">Service time</p></div></div></div><div class="col-5 col-md-3 text-center"><div class="d-flex justify-content-around"><div class="editBox" id="kfc_DT-paid-%id%" hidden><i class="far fa-money-bill-alt"></i></div><div class="editBox" id="kfc_DT-stop-%id%"><img src="./img/fried-chicken-meal.png" class="food-img"/></div><div class="editBox" id="kfc_DT-trash-%id%"><img src="./img/bin.png" class="food-img"/></div></div></div></div></div>'; 
      }
      ...
      if(type === 'kfc_HD') {
        ...
        elementID = obj.id; // to be able to start new stopwatch
        html = '<div class="row py-1 info-container times-container" id="kfc_HD-%id%"><div class="col-4 col-md-3 text-center align-content-center"><input type="text" class="form-control timer" placeholder="Driver description" id="kfc_HD-description%id%"></div><div class="col-3 col-md-6"><div class="d-flex justify-content-between"><div class="col-6 col-md-4 d-none d-md-block text-center"><p class="form-control timer active" id="kfc_HD-start__time%id%">%timeStart%</p></div><div class="col-0 text-center"><p class="form-control timer" id="kfc_HD-paid__time%id%" hidden>Order time</p></div><div class="col-6 col-md-4 d-none d-md-block text-center"><p class="form-control timer" id="kfc_HD-stop__time%id%">Time stop</p></div><div class="col-0 text-center"><p class="form-control timer" id="kfc_HD-otd__time%id%" hidden>Window time</p></div><div class="col-12 col-md-4 text-center"><p class="form-control timer totalTIme-small" id="kfc_HD-total__time%id%">Service time</p></div></div></div><div class="col-5 col-md-3 text-center"><div class="d-flex justify-content-around"><div class="editBox" id="kfc_HD-paid-%id%" hidden><i class="far fa-money-bill-alt"></i></div><div class="editBox" id="kfc_HD-stop-%id%"><img src="./img/bicycle.png" class="food-img"/></div><div class="editBox" id="kfc_HD-trash-%id%"><img src="./img/bin.png" class="food-img"/></div></div></div></div></div>'; 
      }
